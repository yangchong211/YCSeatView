...
public final class SeatPictureUtils {
    ...
    public static Bitmap getRecyclerView(RecyclerView recyclerView) {
        //获取设置的adapter
        ...
        if (adapter != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                //开启绘图缓存
                Bitmap drawingCache = Bitmap.createBitmap(holder.itemView.getMeasuredWidth(),
                        holder.itemView.getMeasuredHeight(), Bitmap.Config.RGB_565);
                Canvas canvas = new Canvas(drawingCache);
                canvas.drawColor(ContextCompat.getColor(recyclerView.getContext(), android.R.color.white));
