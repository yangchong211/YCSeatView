 ...
 * </pre>
 */
public class SeatVerticalView extends LinearLayout implements InterSeatView{

    private Context mContext;
    private RecyclerView mRecyclerView;
    private SeatTypeAdapter2 seatTypeAdapter;
    /**
     * 集合数据
     */
    ...
    public SeatVerticalView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public SeatVerticalView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initRecyclerView(int column, int line) {
        ...
        setRecyclerView(mColumn);
    }

    private void setRecyclerView(int column) {
        ...
        if (seatTypeAdapter==null){
            ...
            initCallBack();
            seatTypeAdapter = new SeatTypeAdapter2(mContext,mList);
     ...
     */
    @Override
    public void addTypeClass(@SeatConstant.Type int type) {
    ...
    public void addLeftClass() {
        ...
        for (int i=0 ; i<size ; i++){
            ...
            if (column==1){
                ...
                SeatLogUtils.i("SeatRecyclerView------左侧增加一列---调课位2--"+i);
            }
        }
        //重排位置，从小到大
