...
public class RecycleViewItemLine extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(@NonNull Rect outRect, @NonNull View view,
        ...
        SeatLogUtils.d("RecycleViewItemLine-------"+"getItemOffsets");
    }
    ...
    public void onDraw(@NonNull Canvas c, @NonNull RecyclerView parent,
        ...
        SeatLogUtils.d("RecycleViewItemLine-------"+"onDraw");
    }
    ...
    public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerView parent,
        ...
        SeatLogUtils.d("RecycleViewItemLine-------"+"onDrawOver");
    }
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        ...
        SeatLogUtils.d("逗比左右的间距分别是" + left + "----"+right);
